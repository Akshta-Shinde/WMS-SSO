...
test("url", function() {
	...
	ok( method( "https://www.føtex.dk/" ), "Valid url, danish unicode characters" );
	ok( method( "https://bösendorfer.de/" ), "Valid url, german unicode characters" );
	ok( method( "https://192.168.8.5" ), "Valid IP Address" );
	ok(!method( "https://192.168.8." ), "Invalid IP Address" );
	ok(!method( "https://bassistance" ), "Invalid url" ); // valid
	ok(!method( "https://bassistance." ), "Invalid url" ); // valid
	ok(!method( "https://bassistance,de" ), "Invalid url" );
	ok(!method( "https://bassistance;de" ), "Invalid url" );
	ok(!method( "https://.bassistancede" ), "Invalid url" );
...
test("url2 (tld optional)", function() {
	...
	ok( method( "https://192.168.8.5" ), "Valid IP Address" );
	ok(!method( "https://192.168.8." ), "Invalid IP Address" );
	ok( method( "https://bassistance" ), "Invalid url" );
	ok( method( "https://bassistance." ), "Invalid url" );
	ok(!method( "https://bassistance,de" ), "Invalid url" );
	ok(!method( "https://bassistance;de" ), "Invalid url" );
	ok(!method( "https://.bassistancede" ), "Invalid url" );
